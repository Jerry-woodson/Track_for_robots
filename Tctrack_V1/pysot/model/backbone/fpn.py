...
def Feature(input):
    model = ResNext50_FPN(output_stride=8)
...
if __name__ == "__main__":
    ...
    #model = ResNext50_FPN(BatchNorm=nn.BatchNorm2d, pretrained=True, output_stride=8)
    #input = torch.rand(1, 3, 480, 640)
    #output = model(input)
    #for out in output:
    #   print(out.size())
    ...
    print("p2 dimensions:",p2.shape)
    print("p3 dimensions:",p3.shape)
    print("p4 dimensions:",p4.shape)
    print("p5 dimensions:",p5.shape)
