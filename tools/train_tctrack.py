...
parser.add_argument('--cfg', type=str, default='/home/lijiarui/TCTrack_v1/TCTrack-main/experiments/TCTrack/config.yaml',
...
def main():
    ...
    if cfg.BACKBONE.PRETRAINED:
        ...
        # backbone_path = os.path.join(cur_path, '/home/lijiarui/TCTrack_v1/TCTrack-main/pretrained_models/temporalalexnet', cfg.BACKBONE.PRETRAINED)
    ...
    # load pretrain
        ...
        cur_path = os.path.dirname(os.path.realpath(__file__))
        # pretrain_path = os.path.join(cur_path, '/home/lijiarui/TCTrack_v1/TCTrack-main/pretrained_models/temporalalexnet',cfg.TRAIN.PRETRAINED)
