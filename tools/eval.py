...
from toolkit.datasets import OTBDataset, LaSOTDataset, UAVTrack112Dataset, UAV10Dataset, UAVDataset, UAVTrack112lDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tracker_prefix', default='general_model', type=str, help='tracker prefix')
