...
class LineVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(LineVideo, self).__init__(name, root, video_dir,
...
def ca():    
    ...
    path='/home/lijiarui/TCTrack_v1/TCTrack-main/MyDataset/'
...
class LineDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(LineDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = LineVideo(video,
                                          dataset_root,
